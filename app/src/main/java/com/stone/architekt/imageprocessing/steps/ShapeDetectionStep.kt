...
class ShapeDetectionStep(
    ...
    override fun process(image: Mat): Mat {
        // This assumes the image is already processed by the previous steps (Grayscale, Blur, Edge Detection)
        ...
        if (contours.isEmpty()) {
            Log.e("ShapeDetectionStep PipelineStep", "contours is emtpy")
        }
